...
if( empty($_POST['noBot']) && isset($_POST['contact_email'])) { 
			...
			$email_subject = "Kaifesh for Congress Request a Yard Sign";
			...
			if( empty($_POST['fname']) ||
				...
				returnArray($return);			
					...
					$email_message .= "<table>";
					$email_message .= "<tr style='background: #eee;'><td align='center' colspan='2'>Request a Yard Sign details below.</td></tr> \n\n\n";					
